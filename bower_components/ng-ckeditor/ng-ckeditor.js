...
(function (angular, factory) {
    ...
    app.directive('storyckeditor', ['$timeout', '$q', function ($timeout, $q) {
    ...
    app.directive('subtitleckeditor', ['$timeout', '$q', function ($timeout, $q) {
    ...
    app.directive('titleimageckeditor', ['$timeout', '$q', function ($timeout, $q) {
